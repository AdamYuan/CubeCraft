...
//http://www.cnblogs.com/dragon2012/p/3891519.html
	void Frustum::CalculatePlanes(glm::mat4 _mvp)
	{
		//
...
//http://www.crownandcutlass.com/features/technicaldetails/frustum.html
	...
	bool Frustum::PointInFrustum(glm::vec3 pos)
	{
		return PointInFrustum(pos.x, pos.y, pos.z);
	}

	bool Frustum::SphereInFrustum(float x, float y, float z, float rad)
	{
		int p;
		float d;
	...
	bool Frustum::SphereInFrustum(glm::vec3 pos, float rad)
	{
	...
	bool Frustum::CubeInFrustum(glm::vec3 pos, float size)
	{
